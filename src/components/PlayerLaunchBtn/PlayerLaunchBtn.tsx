...
export default function PlayerLaunchBtn() {
  ...
  return (
    <Link className={styles.container} to={path} title='Launch Player'>
      <svg ref={svgRef} id="svg-play-btn" className={styles.svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 120">
        <path className={styles.rect} d="M12 10.79h145v97H12z" />
        <path id="open-path" className={`${styles.play} play`}
        ...
        <text className={`${styles.text} more`} x="94" y="100">{ message }&#8230;</text>
      </svg>
    </Link>
  )
}